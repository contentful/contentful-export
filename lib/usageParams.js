...
export default yargs
  ...
  .option('experimental-halt-on-timeout', {
    describe: '[Experimental, undocumented, may change or be removed without notice] Abort the whole export when a single entry/asset/content-type page request times out,',
    type: 'boolean',
    default: false
  })

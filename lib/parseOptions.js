...
export default function parseOptions (params) {
  const defaultOptions = {
    ...
    rawProxy: false,
    // Experimental - undocumented, off by default, may change or be removed without notice.
    // When enabled, a single entry/asset/content-type page request timing out aborts the
    // whole export instead of being logged and skipped.
    experimentalHaltOnTimeout: false
  }
